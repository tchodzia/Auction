...
INSERT INTO `sda-project-auction-site-db`.`auctions` (`id`, `buy_now_price`, `category`, `date_of_issue`, `description`, `end_date`, `localization`, `min_price`, `numbers_of_visitors`, `promoted`, `title`, `user_id`) VALUES ('4', '100.00', '2', '2022-10-06', 'Aukcja4', '2022-10-24', 'Łód', '12.00', '0', 0, 'Aukcja 3', '2');
